...
import { Mail, Lock, Eye, EyeOff, ArrowRight, Sparkles, AlertCircle, Check } from 'lucide-react';
        ...
        <div className="relative z-10 flex flex-col justify-center items-center text-center p-12">
          ...
          >
            ...
            <h2 className="text-3xl font-bold text-white mb-4">
              Build your startup blueprint
            </h2>
            <p className="text-white/80 text-lg max-w-md">
              AI-powered business plans, market analysis, and execution roadmaps in minutes.
            </p>
          </motion.div>
          ...
          <motion.div
            ...
            className="mt-12 p-6 rounded-2xl bg-white/10 backdrop-blur-sm max-w-md"
          >
            <p className="text-white/90 italic mb-4">
              "AutoFounder helped us validate our idea and create a compelling pitch in just one afternoon. Game changer."
            </p>
            <div className="flex items-center gap-3">
              ...
              <div className="text-left">
                ...
                <p className="text-white/70 text-sm">Founder, TechStartup</p>
              </div>
            </div>
          </motion.div>
        </div>
